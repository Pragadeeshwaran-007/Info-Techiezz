...
import { Mail, Send, MapPin, Phone, CheckCircle, Linkedin, Instagram } from 'lucide-react';
...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const mailtoLink = `mailto:support@infotechiezz.com?subject=${encodeURIComponent(
              ...
              <div className="mt-12 pt-8 border-t border-border/50">
                ...
                <div className="flex gap-5">
                  {[
                    {
                      name: 'LinkedIn',
                      href: 'http://www.linkedin.com/in/Infotechiezz',
                      icon: <Linkedin className="w-5 h-5 text-secondary" />,
                      duration: 3
                    },
                    {
                      name: 'X',
                      href: 'https://x.com/infotechiezz',
                      icon: (
                        <svg viewBox="0 0 24 24" aria-hidden="true" className="w-5 h-5 fill-secondary">
                    ...
                    {
                      name: 'Instagram',
                      href: 'https://www.instagram.com/infotechiezz/',
                      icon: <Instagram className="w-5 h-5 text-secondary" />,
                      duration: 4
                    }
                  ].map((social) => (
                    <motion.a
                      ...
                      className="w-12 h-12 rounded-xl bg-secondary/10 flex items-center justify-center hover:bg-secondary/20 transition-all cursor-pointer relative z-20"
                      animate={{
                        y: [0, -10, 0],
                      }}
                      transition={{
