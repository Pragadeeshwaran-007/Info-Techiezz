...
const contests: any[] = [
    {
        ...
        winners: [
            {
                rank: 1,
                name: 'Poorva Devarajan',
                organization: 'EWIT, Bengaluru',
                score: '100.000',
                prize: '₹5000 + Winner Certificate',
                color: '#064e3b',
                bg: '#ecfdf5',
                icon: Trophy
            },
            {
                rank: 2,
                name: 'Loga Priya',
                organization: 'MEC, Namakkal',
                score: '80.000',
                prize: '₹2500 + Winner Certificate',
                color: '#15803d',
                bg: '#f0fdf4',
                icon: Star
            },
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-2">
                                            <span className="text-[10px] font-black px-3 py-1 bg-blue-50 text-blue-600 rounded-full uppercase tracking-widest border border-blue-100">
                                                {selectedEvent.isCompleted ? 'Past Event Results' : 'Upcoming'}
                                            </span>
                                        </div>
                                    </div>
                                    <button 
                                    ...
                                    {selectedEvent.isCompleted ? (
                                        <>
                                            ...
                                            <div className="grid gap-6">
                                                {(selectedEvent.winners || []).map((winner: any, idx: number) => (
                                                    <motion.div
                                                        key={winner.name}
